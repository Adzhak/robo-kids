        ...
        <section id="course">
          ...
          <div className="space-y-3">
            {[
              ...
              {
                num: 4,
                title: "Проект «Вентилятор»",
                desc: "Сборка и программирование вентилятора с регулировкой скорости.",
              },
              {
                num: 5,
              ...
              {
                num: 6,
                title: "Проект «Робот-исследователь»",
                desc: "Финальный проект: автономный робот с несколькими датчиками.",
              },
            ].map((lesson) => (
              <div
                key={lesson.num}
